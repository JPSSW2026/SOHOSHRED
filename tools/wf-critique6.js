export const meta = {
  name: 'soho-shred-round6-score',
  description: 'Round 6: blind A/B on r13 after Cardrona kit, ridge-chain wall, sliver fix, spray/trail fixes - scoring only',
  phases: [{ title: 'Critique', detail: 'blind A/B + 56-point checklist on r13' }],
}
...
const BASE = [
  ...
  'and per-setup exposure metering. Judge r13 as it is - stale memories of earlier',
  'rounds do not apply.',
  '',
  'STEP 1 - BLIND. Read the pairs in ' + ROOT + '/compare/r13/ (pair-*.png, panels A/B,',
  ...
  '',
  'STEP 2 - GRADE ' + ROOT + '/shots/r13/ against the 56-point checklist at the end of',
