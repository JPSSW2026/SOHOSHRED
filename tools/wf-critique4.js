export const meta = {
  name: 'soho-shred-round4-score',
  description: 'Round 4: blind A/B on r11 after the chirality/physics/far-field fixes - scoring only',
  phases: [{ title: 'Critique', detail: 'blind A/B + 56-point checklist on r11' }],
}
...
const BASE = [
  ...
  'and per-setup exposure metering. Judge r11 as it is - stale memories of earlier',
  'rounds do not apply.',
  '',
  'STEP 1 - BLIND. Read the pairs in ' + ROOT + '/compare/r11/ (pair-*.png, panels A/B,',
  ...
  '',
  'STEP 2 - GRADE ' + ROOT + '/shots/r11/ against the 56-point checklist at the end of',
